...
Consider:
	Rebuilding as header only library.
*******************************************************************************/
...
bool simple_irc_socket::IRCSocket::Init() {
...
bool simple_irc_socket::IRCSocket::Connect(char const* host, int port) {
	hostent* he;
...
void simple_irc_socket::IRCSocket::Disconnect() {
	if(_connected) {
		closesocket(_socket);
		_connected = false;
	}
...
bool simple_irc_socket::IRCSocket::SendData(char const* data) {
	if(_connected) {
...
std::string simple_irc_socket::IRCSocket::ReceiveData() {
